...
})({"giTpa":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "242de56bd7730ea9";
"use strict";
...
},{}],"1RLzK":[function(require,module,exports,__globalThis) {
var _galleryItems = require("./gallery-items");
var _basiclightbox = require("basiclightbox");
const gallery = document.querySelector('.gallery');
const markup = (0, _galleryItems.images).map(({ original, preview, description })=>{
...
const handleOnCkick = (e)=>{
    ...
    const instance = _basiclightbox.create(`<div><img class="image-backdrop" src=${image.getAttribute('data-source')} alt=${image.alt}/></div>`, {
        onShow: (instance)=>{
...
},{"./gallery-items":"03UEX","basiclightbox":"io0Ts"}],"03UEX":[function(require,module,exports,__globalThis) {
...
},{}]},["giTpa","1RLzK"], "1RLzK", "parcelRequire4c75", {})

//# sourceMappingURL=goit-js-hw-08.d7730ea9.js.map
